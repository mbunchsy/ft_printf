...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/29 18:40:09 by mramos-j          #+#    #+#             */
/*   Updated: 2020/10/08 20:01:57 by mramos-j         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

static void	ft_numsizq(t_lista *env, unsigned int arg, int arglen)
{
	int espacios;
	int ceros;
...
static void	ft_numsprec(t_lista *env, unsigned int arg, int arglen)
{
	int preclen;
...
static void	ft_numspw(t_lista *env, unsigned int arg, int arglen)
{
	int ceros;
	int espacios;
...
static void	ft_numswidth(t_lista *env, unsigned int arg, int arglen)
{
	int widthlen;
